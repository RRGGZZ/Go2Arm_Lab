...
def GO2_orientation_command_error(env: ManagerBasedRLEnv, command_name: str, asset_cfg: SceneEntityCfg) -> torch.Tensor:
...
def Go2_feet_air_time(
    ...
    # threshold = (torch.norm(env.command_manager.get_command(command_name)[:, :2], dim=1))
