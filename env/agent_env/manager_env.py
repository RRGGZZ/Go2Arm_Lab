...
class ManagerRLEnv(ManagerBasedRLEnv):
    ...
    def step(self, action) :
        self._sim_step_counter = self._sim_step_counter + 1
        ...
        return self.obs_buf, None, self.reward_buf, self.arm_reward_buf, self.reset_terminated, self.reset_time_outs, self.extras
