...
from env.task_cfg.rsl_rl_ppo_cfg import Go2ArmRslRlOnPolicyRunnerCfg
from env.wrappers.VecEnvWrapper import RslRlVecEnvWrapper
...
def prepare_obs(env, agent_cfg:Go2ArmRslRlOnPolicyRunnerCfg):
    """
...
def main():
    ...
    agent_cfg: Go2ArmRslRlOnPolicyRunnerCfg = cli_args.parse_rsl_rl_cfg(args_cli.task, args_cli)
